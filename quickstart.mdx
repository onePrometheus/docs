---
title: "Quickstart"
description: "Set up the minimum environment to get started"
---
...
<AccordionGroup>
  <Accordion icon="copy" title="Create global variables">
...
<AccordionGroup>
  <Accordion icon="github" title="Design your processes">
...
### Step 3: Start your first run

<Accordion icon="rocket" title="Give it a try">
